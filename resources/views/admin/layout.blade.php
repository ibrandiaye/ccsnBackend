            ...
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        ...
                        <a href="{{ route('produit.index') }}">Liste de Produits</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        <a href="{{ route('fournisseur.create') }}">Nouveau Fournisseur</a>
                        <a href="{{ route('fournisseur.index') }}">Liste des Fournisseurs</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    <a class="menu-link" href="page-sellers-cards.html"> <i class="icon material-icons md-arrow_right"></i>
                        <span class="text">Entrée Stock</span>
                    </a>
                    <div class="submenu">
                        <a href="{{ route('entree.create') }}">Nouveau Entree</a>
                        <a href="{{ route('entree.index') }}">Liste des Entrees en Stock</a>
                    </div>
                </li>
