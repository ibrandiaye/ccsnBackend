        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" placeholder="Saisir ici" name="photo" class="form-control" id="photo" required>
                </div>
                <div class="mb-4">
                    <label for="description" class="form-label">Description</label>
                    <input type="text" placeholder="Saisir ici" name="description" class="form-control" id="description" required>
                </div>
                <div class="mb-4">
